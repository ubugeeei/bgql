...
export interface Resolvers<TContext extends BaseContext> {
  ...
  [typeName: string]:
    | TypeResolvers<TContext>
    | SubscriptionResolvers<TContext>
    | undefined;
}
 ...
 * Not found error.
 */
export interface NotFoundErrorResult extends BaseError {
 ...
 * Forbidden error.
 */
export interface ForbiddenErrorResult extends BaseError {
