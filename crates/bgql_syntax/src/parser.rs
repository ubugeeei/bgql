...
impl<'a> Parser<'a> {
    ...
    fn parse_definition(&mut self) -> Option<Definition<'a>> {
        ...
        match self.at() {
            ...
            TokenKind::Opaque => Some(Definition::Type(TypeDefinition::Opaque(
                self.parse_opaque_type(description),
            ))),
    ...
    /// Parses interface type definition.
    ...
    /// Parses input object type definition.
    ...
    /// Parses input union type definition.
