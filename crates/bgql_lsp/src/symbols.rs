...
use bgql_syntax::{
    Definition, Document, EnumTypeDefinition, FieldDefinition, InputObjectTypeDefinition,
    InputUnionTypeDefinition, InterfaceTypeDefinition, ObjectTypeDefinition, OpaqueTypeDefinition,
    ScalarTypeDefinition, TypeAliasDefinition, TypeDefinition, UnionTypeDefinition,
};
...
impl SymbolType {
    pub fn to_lsp_kind(self) -> SymbolKind {
        match self {
            ...
            SymbolType::Union | SymbolType::InputUnion => SymbolKind::ENUM,
